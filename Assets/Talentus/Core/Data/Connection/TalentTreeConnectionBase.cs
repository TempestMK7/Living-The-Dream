...
namespace com.cygnusprojects.TalentTree
{
	...
	public class TalentTreeConnectionBase : ScriptableObject
    {
...
#if UNITY_EDITOR
        public virtual void UpdateConnectionGUI(Event e, Rect viewRect, GUISkin viewSkin, Color requiredTypeColor, Color optionalTypeColor)
        {
            ProcessEvents(e, viewRect);

            if (fromNode != null && toNode != null)
            {                
                curvePoints = DrawNodeCurve(fromNode.nodeRect, toNode.nodeRect, requiredTypeColor, optionalTypeColor);
            }
        ...
        public Vector3[] DrawNodeCurve(Rect start, Rect end, Color requiredTypeColor, Color optionalTypeColor)
        {
            return DrawNodeCurve(start, end, new Vector2(1f, 0.5f), new Vector2(0f, 0.5f), requiredTypeColor, optionalTypeColor);
        }

        public Vector3[] DrawNodeCurve(Rect start, Rect end, Vector2 vStartPercentage, Vector2 vEndPercentage, Color requiredTypeColor, Color optionalTypeColor)
        {
