...
namespace Com.Tempest.Nightmare {
    public class TalentInfoDictionaryContainer {
        ...
        public static Dictionary<TalentEnum, TalentDescriptions> infoDictionary = new Dictionary<TalentEnum, TalentDescriptions> {
            ...
            { TalentEnum.JUMP_HEIGHT_OR_ACCELERATION, new TalentDescriptions("Increased Agility", "This increases the base jump speed of non-flying characters and the acceleration speed of flying characters.", 3, 250,
            ...
            { TalentEnum.MOVEMENT_SPEED, new TalentDescriptions("Movement Speed", "Increases the base movement speed for your character.  I fully expect this talent to break the game, but I'm running out of ideas.", 3, 250,
                new string[] { "Increases base movement speed by 3%.", "Increases base movement speed by 6%.", "Increases base movement speed by 10%." }) },

            // Explorer Talents.
            { TalentEnum.BONFIRE_SPEED, new TalentDescriptions("Bonfire Speed", "This increases the rate at which you light bonfires.", 3, 50,
                new string[] { "Increases bonfire speed by 5%.", "Increases bonfire speed by 10%.", "Increases bonfire speed by 15%." }) },
            { TalentEnum.FIRST_BONFIRE_SPEED, new TalentDescriptions("First Bonfire Bonus", "Touching a bonfire for the first time each game will instantly add a lot of progress to that bonfire.", 3, 50,
            ...
            { TalentEnum.PORTAL_NOTIFICATIONS, new TalentDescriptions("Portal Notifications", "You will receive screen-edge notifications whenever a portal is opened by any explorer.", 2, 100,
                new string[] { "Shows notifications for portals that are opened.", "Shows notifications for portals that are in progress." }) },
            { TalentEnum.BONFIRE_PROGRESS_NOTIFICATIONS, new TalentDescriptions("Bonfire Progress Notifications", "Adds screen-edge notifications for all bonfires that are currently in progress.", 1, 100,
                new string[] { "Adds notifications for bonfires that are in progress." }) },
            { TalentEnum.PORTAL_COOLDOWN_REDUCTION, new TalentDescriptions("Portal Cooldown", "Reduces the cooldown period for jumping through activated portals.  The base cooldown is 60 seconds.", 3, 200,
                new string[] { "Reduces the cooldown by 5 seconds.", "Reduces the cooldown by 5 seconds.", "Reduces the cooldown by 5 seconds." }) },
            { TalentEnum.HEALTH_STATION_COOLDOWN_REDUCTION, new TalentDescriptions("Health Station Cooldown", "Using a health station will immediately refund part of the normal cooldown.", 3, 200,
                new string[] { "Refunds 10% of the cooldown.", "Refunds 25% of the cooldown.", "Refunds 50% of the cooldown." }) },
            { TalentEnum.FASTER_FALL_SPEED, new TalentDescriptions("Faster Fall Speed", "Adds a downward snap to your fast fall, allowing for more unpreditable movement.", 3, 250,
            ...
            { TalentEnum.RESET_MOVEMENT_ON_WALL_SLIDE, new TalentDescriptions("Reset Movement Ability On Wall Slide", "Grabbing onto walls will reset your double-jump, dash, or jetpack usage.  Normally, jumps and dashes are only reset when landing on the ground.", 2, 250,
